export default class LevelManager {
  ...
  constructor(
    ...
    level: number = 1,
    callback: Function,
    timeLevel: number = 30000
  ) {
    this._game = game;
    this._level = level;
    this._timeForLevel = timeLevel;
    this.levelLabel = this._game.add
      .bitmapText(100, -100, "arial-stroke", "Level " + String(this._level))
      .setScale(3.0);

    this.initLevelTimer(callback);
  }

  private initLevelTimer(callb: Function): void {
